import { a as createComponent, r as renderComponent, e as renderScript, b as renderTemplate, m as maybeRenderHead } from '../chunks/astro/server_DSpow1EJ.mjs';
import 'kleur/colors';
...
const $$Index = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "BaseLayout", $$BaseLayout, { "title": pageTitle, "description": pageDescription, "data-astro-cid-2hwget37": true }, { "default": ($$result2) => renderTemplate`  ${renderComponent($$result2, "GhibliPixelBanner", $$GhibliPixelBanner, { "variant": "hero", "className": "neodev-hero", "data-astro-cid-2hwget37": true }, { "default": ($$result3) => renderTemplate` ${maybeRenderHead()}<div class="hero-content text-center" data-astro-cid-2hwget37> <h1 class="text-6xl font-display font-bold mb-6 text-gradient" data-astro-cid-2hwget37>
Projects Gallery
...
</p> </div> ` })}  ${renderComponent($$result2, "GhibliPixelBanner", $$GhibliPixelBanner, { "variant": "divider", "height": "80px", "data-astro-cid-2hwget37": true })}  <section class="py-20 px-6 bg-gradient-to-b from-bg-primary to-bg-secondary" data-astro-cid-2hwget37> <div class="max-w-7xl mx-auto" data-astro-cid-2hwget37> <div class="neodev-grid neodev-grid-3" data-astro-cid-2hwget37> ${sampleProjects.map((project) => renderTemplate`${renderComponent($$result2, "GhibliProjectCard", $$GhibliProjectCard, { "title": project.title, "description": project.description, "category": project.image.replace("-", ""), "impact": project.impact, "status": project.status, "collaborators": project.collaborators, "computeHours": project.computeHours, "href": `/projects/${project.id}`, "data-astro-cid-2hwget37": true })}`)} </div> </div> </section>  <section class="cta-section" data-astro-cid-2hwget37> <div class="container" data-astro-cid-2hwget37> <div class="cta-card quantum-glass" data-astro-cid-2hwget37> <div class="cta-content" data-astro-cid-2hwget37> <h2 class="cta-title" data-astro-cid-2hwget37>Have a Breakthrough Idea?</h2> <p class="cta-description" data-astro-cid-2hwget37>
